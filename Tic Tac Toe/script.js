...
const checkWin1 = () =>{
    ...
    // if(!isgameover && wins.forEach(e =>{
    //     if((boxtext[e[0]]!=='') && (boxtext[e[1]]!=='') && (boxtext[e[2]]!=='')){
    //         document.querySelector('.info').innerText ="That's a DRAw";
...
//     Array.from(boxtexts).if((element.innerText !=='')=>{
